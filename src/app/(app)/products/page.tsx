  ...
  return (
    <div>
      ...
      >
        <Button
          onClick={openAdd}
          className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold h-9 px-4 rounded-lg shadow-sm"
        >
      ...
      {/* Filters */}
      <div className="flex flex-wrap gap-3 mb-5 bg-white border border-slate-200 rounded-xl p-3">
        <SearchInput
          value={search}
          onChange={(v) => {
            setSearch(v);
        ...
        >
          <SelectTrigger className="w-40 h-9 border-slate-200 text-sm">
